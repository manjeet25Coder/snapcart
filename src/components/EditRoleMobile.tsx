...
function EditRoleMobile() {
  ...
  return (
    <div className='flex flex-col min-h-screen p-6 w-full items-center'>
      ...
      >
        <label htmlFor='mobile' className='text-gray-700 fon-medium mb-2'>Enter Your Mobile No.</label>
        <input
         type="tel" 
         id="mobile" 
     ...
     initial={{ opacity: 0, y: 20 }}
        ...
        className={`inline-flex items-center gap-2 font-semibold py-3 px-8 rounded-2xl shadow-md
          ...
          ${
            ...
            ? "bg-green-600 hover:bg-green-700 tet-white"
