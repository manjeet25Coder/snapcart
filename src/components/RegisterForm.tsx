        ...
        text-green-700 hover:text-green-800 transition-colors cursor-pointer'
            ...
            {error && (
                <motion.div 
                    ...
                    className="w-full max-w-sm mb-4 p-3 bg-red-50 border border-red-200 text-red-600 rounded-xl text-sm text-center"
                >
                    {error}
                </motion.div>
            )}
            ...
            >
                ...
                cursor-pointer' onClick={() => setShowPassword(false)} /> : <EyeIcon className='absolute right-3 top-3.5 w-5 h-5 text-gray-500
                ...
                <div className='flex items-center gap-2 text-gray-400 text-sm mt-2'>
                 ...
                 <button type="button" className='w-full flex items-center justify-center gap-3 border
