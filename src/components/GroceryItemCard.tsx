...
function GroceryItemCard({item}:{item:IGrocery}) {
  return (
    ...
    className='bg-white rounded-2xl shadow-sm hover-xl transition-all duration-300
...
<motion.button className='mt-4 flex items-center justify-center gap-2 bg-green-600
hover:bg-green-700 text-white rounded-full py-2 text-sm font-medium transition-all'
whileTap={{scale:0.96}}>
